...
inline size_t HalfedgeMesh::nHalfedges(void) const {
  return rawHalfedges.size();
}
...
inline size_t HalfedgeMesh::nBoundaryLoops(void) const {
  return rawBoundaryLoops.size();
}
inline size_t HalfedgeMesh::nImaginaryHalfedges(void) const {
  return rawImaginaryHalfedges.size();
}

// Dual

inline size_t HalfedgeDual::nHalfedges(void) const {
  return rawHalfedges.size();
}
